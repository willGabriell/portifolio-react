export default function Inicio() {
    return (
        <div className="flex flex-col md:flex-row items-center justify-center m-5 p-4">
            <div className="w-96 h-96 bg-blue-600 mb-6 md:mb-0 md:mr-10"></div>

            <div className="flex flex-col items-center justify-center max-w-lg p-5 text-white">
                ...
                <div className="flex flex-wrap justify-center text-black">
                    ...
                    <a href="https://linkedin.com/in/wilinton-gabriel" target='_blank' className="bg-red-500 hover:bg-red-600 transition-all duration-300 ease-in-out w-48 rounded-3xl flex items-center justify-center p-1 m-3">
