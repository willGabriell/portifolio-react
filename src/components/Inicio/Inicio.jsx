export default function Inicio() {
    return (
        <div className="flex md:flex-row flex-col items-center justify-center m-5">
            <div className="w-96 h-96 bg-blue-600"></div>

            <div className="flex flex-col items-center justify-center max-w-lg p-3 text-white">
                <h2 className="font-bold text-2xl">Wilinton Gabriel</h2>
